...
public class RegistrationTests extends AbstractTester {
        ...
        public void setup() {
                ...
                try {
                        ...
                        SocketAddress address = new InetSocketAddress(service.servicePort(service.selfRegistrationServiceUri()));
        ...
        public void duplicateUser() {
                ...
                assertTrue(
                        registrationService.register(
                                ...
                                USER_ORGANISATION,
                                USER_KIND
                        ) == RegistrationService.REGISTRATION_OK
                );
                ...
                assertTrue(
                        registrationService.register(
                                ...
                                USER_ORGANISATION,
                                USER_KIND
                        ) == RegistrationService.REGISTRATION_FAIL_DUPLICATE
                );
        ...
        public void incompleteUser() {
                ...
                assertTrue(
                        registrationService.register(
                                ...
                                USER_ORGANISATION,
                                USER_KIND
                        ) == RegistrationService.REGISTRATION_FAIL_INCOMPLETE
                );
