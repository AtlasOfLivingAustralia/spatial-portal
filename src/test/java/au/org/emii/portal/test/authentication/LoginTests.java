...
public class LoginTests extends AbstractTester {
    ...
    public void testLoginOk() {
        ...
        assertTrue(loginService.login(session, MockGeoNetworkXmlUserLoginService.GOOD_USER, MockGeoNetworkXmlUserLoginService.GOOD_PASSWORD));
    ...
    public void testLoginFail() {
        ...
        assertFalse(loginService.login(session, MockGeoNetworkXmlUserLoginService.GOOD_USER, MockGeoNetworkXmlUserLoginService.BAD_PASSWORD));
        ...
        session = new PortalSession();
        assertFalse(loginService.login(session, MockGeoNetworkXmlUserLoginService.BAD_USER, MockGeoNetworkXmlUserLoginService.BAD_PASSWORD));
        assertFalse(session.isLoggedIn());

        session = new PortalSession();
        assertFalse(loginService.login(session, MockGeoNetworkXmlUserLoginService.BAD_USER, MockGeoNetworkXmlUserLoginService.GOOD_PASSWORD));
        assertFalse(session.isLoggedIn());
    }
