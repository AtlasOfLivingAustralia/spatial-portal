<%-- 
When there is an error and the user has no session, they get sent to this
page manually by SessionInit.init()
 --%>
...
<div class="zk" id="z_5a_0" z.dtid="g5a01" style="width:100%;height:100%;" z.zidsp="page" z.au="/webportal/zkau">
    ...
    <div id="z_5a_2" z.type="zul.wnd2.Wnd2" z.autoz="true" class="z-window-embedded"
         style="width:100%;height:100%;overflow:hidden;" z.zcls="z-window-embedded" z.minheight="100" z.minwidth="200">
        <div id="z_5a_2!cave" class=" z-window-embedded-cnt-noborder">
            ...
            <div id="z_5a_5" class="z-border-layout" style="width:100%;" z.zcls="z-border-layout"
                 z.type="zkex.zul.borderlayout.BorderLayout2">
                <div id="z_5a_6" z.type="zkex.zul.borderlayout.LayoutRegion2">
                    <div id="z_5a_6!real" class="z-north " style="height:100;" z.zcls="z-north" z.cid="z_5a_7"
                         z.pos="north" z.flex="false" z.mars="0,0,0,0" z.cmars="5,5,5,5" z.colps="false" z.open="true"
                         z.splt="false" z.maxs="2000" z.mins="0" z.autoscl="false">
                        <div id="z_5a_6!cave" class="z-north-body">
                            <div id="z_5a_7">
                            </div>
                        </div>
                    </div>
            ...
            <div id="z_5a_9" z.type="zkex.zul.borderlayout.LayoutRegion2">
                <div id="z_5a_9!real" class="z-center " z.zcls="z-center" z.cid="z_5a_a" z.pos="center" z.flex="false"
                     z.mars="0,0,0,0" z.cmars="5,5,5,5" z.colps="false" z.open="true" z.splt="false" z.maxs="2000"
                     z.mins="0" z.autoscl="false">
                    <div id="z_5a_9!cave" class="z-center-body">
                        <div id="z_5a_a" class="msgcenter">
                            <div id="z_5a_b">
				...
				<span z.type="zul.btn.Button" id="z_5a_f" class="z-button" z.zcls="z-button" z.href="/webportal/./"><table
                    ...
                    <tr>
                        <td class="z-button-tl">
                            <button id="z_5a_f!real" class="z-button"></button>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="z-button-cm">RELOAD PORTAL</td>
            ...
            <div id="z_5a_g" z.type="zkex.zul.borderlayout.LayoutRegion2">
                <div id="z_5a_g!real" class="z-south " z.zcls="z-south" z.cid="z_5a_h" z.pos="south" z.flex="false"
                     z.mars="0,0,0,0" z.cmars="5,5,5,5" z.colps="false" z.open="true" z.splt="false" z.maxs="2000"
                     z.mins="0" z.autoscl="false">
