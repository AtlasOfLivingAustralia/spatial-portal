    ...
    <div class="col-wide last" style="width:100%">
        ...
        <c:forEach items="${tabulations}" var="layer" varStatus="status">
            <tr>
                ...
                <!-- area -->
                <td>
                    <a href='tabulation/area/${layer.fid1}/${layer.fid2}/tabulation.html'>html</a>
                ...
                <td>
                    <a href='tabulation/area/row/${layer.fid1}/${layer.fid2}/tabulation.html'>html</a>
                    <a href='tabulation/area/row/${layer.fid1}/${layer.fid2}/tabulation.csv'>csv</a>
                    <a href='tabulation/area/row/${layer.fid1}/${layer.fid2}/tabulation.json'>json</a>
                </td>
                <td>
                ...
                <td>
                    <a href='tabulation/species/row/${layer.fid1}/${layer.fid2}/tabulation.html'>html</a>
                    <a href='tabulation/species/row/${layer.fid1}/${layer.fid2}/tabulation.csv'>csv</a>
                    <a href='tabulation/species/row/${layer.fid1}/${layer.fid2}/tabulation.json'>json</a>
                </td>
                <td>
                ...
                <td>
                    <a href='tabulation/occurrences/row/${layer.fid1}/${layer.fid2}/tabulation.html'>html</a>
                    <a href='tabulation/occurrences/row/${layer.fid1}/${layer.fid2}/tabulation.csv'>csv</a>
                    <a href='tabulation/occurrences/row/${layer.fid1}/${layer.fid2}/tabulation.json'>json</a>
                </td>
                <td>
