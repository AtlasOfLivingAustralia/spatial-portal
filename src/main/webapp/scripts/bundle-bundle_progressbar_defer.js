...
(function (a) {
    ...
    h.prototype = {constructor: h, transition: function () {
    ...
    a.fn.progressbar.defaults = {transition_delay: 300, refresh_speed: 50, display_text: a.fn.progressbar.display_text.none, use_percentage: !0, update: a.noop, done: a.noop, fail: a.noop};
