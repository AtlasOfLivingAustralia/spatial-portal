...
public class SitesBySpeciesWSControllerTabulated {
    ...
    String processgeoq(HttpServletRequest req) {
        ...
        try {
            ...
            AnalysisJobSitesBySpeciesTabulated sbs = new AnalysisJobSitesBySpeciesTabulated(pid, currentPath, qname, speciesq, gridsize, region, filter, sitesbyspecies, occurrencedensity, speciesdensity, biocacheurl, layer, true, facetName);
