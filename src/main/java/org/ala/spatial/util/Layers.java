...
public class Layers {
    ...
    static public String[] listLayers() {
        String[] layers = new String[TabulationSettings.environmental_data_files.length
    ...
    public static String layerDisplayNameToName(String display_name) {
        ...
        for (Layer l : TabulationSettings.geo_tables) {
            if (l.display_name.equalsIgnoreCase(display_name)
                    || l.name.equalsIgnoreCase(display_name)) {
                layer_name = l.name;
                break;
            }
        }
