...
public class GDMComposer extends ToolComposer {
    ...
    public boolean runGDMStep1() {
        try {
            ...
            PostMethod get = new PostMethod((CommonData.satServer + "/ws/gdm/step1?") + "&envlist=" + URLEncoder.encode(sbenvsel, "UTF-8") + "&taxacount=" + vSp.size());
    ...
    public void loadMap(Event event) {
        ...
        for (String env : envlist) {
            ...
            UserPointsUtil.addAnalysisLayerToUploadedCoordinates(getPortalSession(), pid + "_" + env, layername);
        }
