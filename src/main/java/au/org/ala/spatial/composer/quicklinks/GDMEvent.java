...
public class GDMEvent implements EventListener {
    ...
    public GDMEvent(String speciesLayerName, String polygonLayerName, String environmentalLayerName) {
    ...
    public void onEvent(Event event) throws Exception {
        ...
        ((MapComposer) event.getPage().getFellow(StringConstants.MAPPORTALPAGE)).openModal("WEB-INF/zul/tool/GDM.zul", params, StringConstants.ADDTOOLWINDOW);
    }
}
