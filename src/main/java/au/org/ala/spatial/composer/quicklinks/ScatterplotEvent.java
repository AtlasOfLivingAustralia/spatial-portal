 ...
 * @author adam
 */
public class ScatterplotEvent implements EventListener {

    private String speciesLayerName;
    private String polygonLayerName;
    private String environmentalLayerName;

    public ScatterplotEvent(String speciesLayerName, String polygonLayerName, String environmentalLayerName) {
