...
import au.org.ala.spatial.composer.tool.MaxentComposer;
 ...
 * @author adam
 */
public class PredictionEvent implements EventListener {
    ...
    public void onEvent(Event event) throws Exception {
        ...
        MaxentComposer window = (MaxentComposer) mc.openModal("WEB-INF/zul/tool/Maxent.zul", params, "addtoolwindow");
