...
,displaypath =             'http://spatial-dev.ala.org.au/geoserver/gwc/service/wms?service=WMS&version=1.1.0&request=GetMap&layers=ALA:nrm_regions_2010&format=image/png&styles='
,environmentalvalueunits = 'class'
