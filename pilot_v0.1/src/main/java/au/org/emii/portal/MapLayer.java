...
public class MapLayer extends AbstractIdentifier implements TreeMenuValue, Cloneable, Serializable {
    ...
    /**
     * OGC Filter -- layer parameter
     */
    protected String ogcFilter = null;
	/**
	...
	/**
	 * @param ogcFilter the ogcFilter to set
	 */
	public void setOgcFilter(String ogcFilter) {
    ...
    /**
     * Wrapper for getOgcFilter() with javascript chars escaped
     * @return
     */
    public String getOgcFilterJS() {
            return StringEscapeUtils.escapeJavaScript(getOgcFilter());
