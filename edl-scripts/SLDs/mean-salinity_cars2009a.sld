    ...
    <sld:Rule>
      <sld:RasterSymbolizer>
        ...
        <sld:ColorMap>
          ...
          <sld:ColorMapEntry color="#FFA000" quantity="19740.4"/>
          <sld:ColorMapEntry color="#FF5B00" quantity="26252.7"/>
          <sld:ColorMapEntry color="#FF0000" quantity="32765.0" label="32765.0 PSU"/>
        </sld:ColorMap>
      </sld:RasterSymbolizer>
    </sld:Rule>
  </sld:FeatureTypeStyle>
