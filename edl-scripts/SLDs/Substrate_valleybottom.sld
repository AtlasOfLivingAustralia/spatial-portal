    ...
    <sld:Rule>
      <sld:RasterSymbolizer>
        ...
        <sld:ColorMap>
          ...
          <sld:ColorMapEntry color="#A0FF00" quantity="37.5"/>
          <sld:ColorMapEntry color="#FFFF00" quantity="50.0"/>
          <sld:ColorMapEntry color="#FFC814" quantity="68.75"/>
          <sld:ColorMapEntry color="#FFA000" quantity="87.5"/>
