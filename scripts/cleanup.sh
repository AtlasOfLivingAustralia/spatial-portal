...
find /usr/local/tomcat/instance_03_webportal/webapps/webportal/print -type d  -mtime +2 -exec rm -r {} \; 1>> $OUTPUTFILE 2>&1
find /usr/local/tomcat/instance_03_webportal/webapps/webportal/print -mtime +2 -exec rm {} \; 1>> $OUTPUTFILE 2>&1
