...
public class UploadSpatialResource {
    ...
    public static String putCall(String url, String username, String password, String resourcepath, String contenttype){
    	String output = "";
        ...
        RequestEntity entity = new FileRequestEntity(input, contenttype);
        put.setRequestEntity(entity); 
    ...
    public static String postCall(String url, String username, String password, String resourcepath, String contenttype){
    	String output = "";
