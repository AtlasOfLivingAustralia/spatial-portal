 ...
 * @author Adam Collins
 */
public class AndRegion extends SimpleRegion implements Serializable {

    /**
     * member regions for AND operations
     */
    ArrayList<SimpleRegion> andRegions;
     ...
     */
    public static AndRegion parseSimpleRegion(String pointsString) {
        return null;
    }
