			...
			if (mapLayer != null) {
				...
				if (holder == null) {
                    ...
                    */
                    ...
                    // sometimes it seems that we can get a value back for position in tree
                    // that's greater than the size of the list - strange - perhaps due to
                    // concurrent modification, but try and protect against this
                    if (positionInTree <= holder.getParent().getChildren().size() -1) {
