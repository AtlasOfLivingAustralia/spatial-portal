...
import au.org.emii.portal.AnimationSelection;
...
public class ThreddsSupport extends NcWMSSupport {
	public final static String MAXIMUM_ALLOWED_FRAMES = "thredds_maximum_allowed_frames";
	...
	protected void setType(MapLayer mapLayer, Layer layer) {
		mapLayer.setType(LayerUtilitiesImpl.THREDDS);
	}
	...
	public boolean maxFramesExceeded(MapLayer mapLayer) {
		return (countSelectedFrames(mapLayer) > settingsSupplementary.getValueAsInt(MAXIMUM_ALLOWED_FRAMES));
	}
