...
import au.org.emii.portal.HttpConnectionImpl;
...
public class RemoteRequestServlet implements HttpRequestHandler {
    ...
    private void initAllowedHosts(HttpServletRequest request) {
        ...
        ConfigurationLoaderStage1 stage1 = 
                (ConfigurationLoaderStage1) servletContext.getAttribute(ApplicationInit.CONFIGURATION_LOADER_ATTRIBUTE);
