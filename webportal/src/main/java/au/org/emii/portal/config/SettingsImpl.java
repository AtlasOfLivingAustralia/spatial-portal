...
public class SettingsImpl implements Settings {
    ...
    /**
     * Selects whether the selected left menu tab will be an facility, region or realtime
     */
    ...
    private boolean adminConsoleDisabled = false;
    private boolean portalUsersDisabled = false;
    ...
    public void setPortalUsersDisabled(boolean disabled) {
        this.portalUsersDisabled = disabled;
    }

    @Override
    public void setAdminConsoleDisabled(boolean disabled) {
        this.adminConsoleDisabled = disabled;
    }
