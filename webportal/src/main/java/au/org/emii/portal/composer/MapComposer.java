...
public class MapComposer extends GenericAutowireAutoforwardComposer {
    ...
    private HtmlMacroComponent MESTSearchComposer; /// fix this
    private HtmlMacroComponent leftMenuSearchComposer; /// fix this
    ...
    /**
     * Hide page components not for unprivileged users
     */
    ...
    /**
     * Show page components not for privileged users
     */
