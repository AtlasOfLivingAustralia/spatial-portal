...
import au.org.emii.portal.DatasetDescription;
import au.org.emii.portal.FeatureType;
...
public class MESTFreeTextSearch {
	...
	public boolean ParseResult() {
        ...
        if (doc == null) {
            // error getting data - mest down?
            logger.warn("No data received from MEST for search query - is MEST down?");
            bResult = false;
        } else {
