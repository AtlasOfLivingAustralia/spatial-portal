...
public class SessionInitImpl implements SessionInit, DesktopInit {
    ...
    private ConfigurationLoaderStage1 getConfigurationLoaderStage1(Session session) {
        return getApplicationContext(session).getBean(ConfigurationLoaderStage1.class);
    }
    ...
    private void waitForPortalReload(ConfigurationLoaderStage1 stage1) {
    ...
    public void init(Session session, Object request) throws Exception {
        ...
        ConfigurationLoaderStage1 stage1 = getConfigurationLoaderStage1(session);
        ...
        if (stage1.isReloading()) {
            ...
            redirectAndInvalidateSession(session, "/WEB-INF/jsp/Error.jsp");
        } else {
    ...
    public void init(Desktop desktop, Object request) throws Exception {
        ...
        if (session == null) {
            ...
            redirectAndInvalidateSession(desktop.getSession(), "/WEB-INF/Error.jsp");
        } else {
            // user has a session...
